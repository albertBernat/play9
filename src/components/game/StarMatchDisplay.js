...
const StarMatchDisplay = ({gameStatus, startNewGame, stars, checkNumberStatus, onNumberClick, secondLeft}) => {
    return (
        <div className="game">
            <div className="help">
            ...
            <div className="body">
                <div className="left">
                    {
                        gameStatus !== ACTIVE ?
                            <PlayAgain onClick={startNewGame} gameStatus={gameStatus}/> : <StarsDisplay count={stars}/>
                    }
                </div>
                <div className="right">
